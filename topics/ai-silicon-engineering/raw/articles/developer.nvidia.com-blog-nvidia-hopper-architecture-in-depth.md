...
*   [E](mailto:?subject=I'd like to share a link with you&body=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fnvidia-hopper-architecture-in-depth%2F)
...
![NVIDIA H100 GPU SXM5 Module](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20291%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU HPC and AI Preliminary Performance Chart using from 8 to 256 H100 GPUs](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20264%22%3E%3C/svg%3E)
...
![NVIDIA GH100 GPU Full-chip block diagram](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20279%22%3E%3C/svg%3E)
...
![NVIDIA GH100 GPU SM (Streaming Multiprocessor) block diagram](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20869%22%3E%3C/svg%3E)
...
![NVIDIA Hopper H100 GPU FP16 Tensor Core structure and throughput diagram compared to NVIDIA Ampere A100 GPU FP16 Tensor Core structure and throughput](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20346%22%3E%3C/svg%3E)
...
![New Floating Point FP8 Tensor Core Precision formats and accumulator types](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20340%22%3E%3C/svg%3E)

_Figure 6. New NVIDIA Hopper FP8 precisions: 2x throughput and half the footprint of H100 FP16 or BF16_

![NVIDIA Hopper H100 GPU FP8 Tensor Core structure and throughput diagram compared to NVIDIA Ampere A100 GPU FP16 Tensor Core structure and throughput](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20374%22%3E%3C/svg%3E)

_Figure 7. H100 FP8 Tensor Core has 6x throughput compared to A100 FP16 Tensor Core_

![NVIDIA H100 GPU TF32, FP64, and INT8 Tensor Core structure and throughput diagram compared to NVIDIA A100 GPU TF22, FP64, INT8 Tensor Core structure and throughput](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20351%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU's new DPX Instruction usage examples and performance](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20239%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU compute performance improvement over NVIDIA A100 GPU](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20300%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU Thread Block Clusters and Grids that include Thread Block Clusters compared to Grids of Thread Blocks](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20185%22%3E%3C/svg%3E)
...
![NVIDIA A100 GPU vs H100 GPU Thread Block data exchange differences. H100 includes a direct SM-to-SM network in a Cluster.](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20135%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU Cluster Performance Examples with three algorithms](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20482%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU asynchronous execution enhancements overview](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20257%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU new Tensor Memory Accelerator address generation example](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20238%22%3E%3C/svg%3E)
...
![Comparison of NVIDIA H100 GPU new Tensor Memory Accelerator versus NVIDIA A100 GPU LDGSTS Instruction to perform memory copies](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20277%22%3E%3C/svg%3E)
...
![New NVIDIA H100 GPU asynchronous transaction barrier feature compared to NVIDIA A100 GPU asynchronous barrier](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20214%22%3E%3C/svg%3E)
...
![New NVIDIA H100 GPU HBM3 DRAM Bandwidth comparison to NVIDIA A100, V100, and P100 GPU HBM2 DRAM bandwidths](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20458%22%3E%3C/svg%3E)
...
![Transformer Model Size and Complexity Increases in recent years with examples](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20260%22%3E%3C/svg%3E)
...
![NVIDIA H100 GPU Transformer Engine conceptual operation diagram](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20523%22%3E%3C/svg%3E)
...
![NVIDIA's new DGX H100 SuperPOD 256 GPU clustered system performance compared to DGX A100 SuperPOD](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20625%20330%22%3E%3C/svg%3E)
...
![The NVIDIA HGX H100 is a key GPU server building block powered by the Hopper architecture.](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20512%20288%22%3E%3C/svg%3E)
...
![](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20556%20370%22%3E%3C/svg%3E)
...
![Decorative image.](data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%20660%20370%22%3E%3C/svg%3E)
...
[Build and Stream Browser-Based XR Experiences with NVIDIA CloudXR.js](https://developer.nvidia.com/blog/build-and-stream-browser-based-xr-experiences-with-nvidia-cloudxr-js/)
...
*   [F](https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fnvidia-hopper-architecture-in-depth%2F)
*   [R](https://www.reddit.com/submit?url=https%3A%2F%2Fdeveloper.nvidia.com%2Fblog%2Fnvidia-hopper-architecture-in-depth%2F&title=NVIDIA+Hopper+Architecture+In-Depth+%7C+NVIDIA+Technical+Blog)
*   [E](mailto:?subject=I'd like to share a link with you&body=https%3A%2F%2Fdeveloper.nvidia.c